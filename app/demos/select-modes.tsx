...
import styles from './select-modes.module.css';

const fonts = [
  { label: 'Select a library', value: null },
  { label: 'Ariakit', value: 'ariakit' },
...
export default function SelectModesDemo() {
  return (
    <Frame className="gap-24">
      <StyledSelect />
      <StyledSelect alignItemWithTrigger={false} align="start" />
    </Frame>
  );
}

function StyledSelect(props: React.ComponentProps<typeof Select.Positioner>) {
  return (
    <Select.Root items={fonts}>
      ...
      <Select.Portal>
        <Select.Positioner className={styles.Positioner} sideOffset={8} {...props}>
